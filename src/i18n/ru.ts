...
const ru: Record<TranslationKey, string> = {
  ...
  'hero.new.title': 'Внедрение технологий для устранения операционных сбоев',
  'hero.new.desc': 'Shiiift — стратегический партнер по технической реализации, основанный Исааком Фельдманом. Мы помогаем компаниям автоматизировать рутину, создавать конвертящие сайты, упрощать стек инструментов и внедрять ИИ-сценарии. Используйте консоль ниже, чтобы найти узкие места и получить готовое коммерческое предложение.',
