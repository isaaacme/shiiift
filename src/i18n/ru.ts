...
const ru: Record<TranslationKey, string> = {
  ...
  'hero.new.desc': 'Без сложного тех-жаргона и раздутых решений. Shiiift — стратегический партнер по внедрению, основанный Исааком Фельдманом. Мы связываем ваши программы, автоматизируем рутину, ускоряем сайты и внедряем ИИ там, где он реально бережет ваши часы. Выберите инструмент ниже, чтобы найти слабые места и увидеть нас в деле.',
