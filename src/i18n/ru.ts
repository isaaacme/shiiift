...
const ru: Record<TranslationKey, string> = {
  ...
  'hero.subheadline':
    'Я создаю быстрые сайты, автоматизирую процессы и внедряю ИИ-системы, чтобы сэкономить ваше время. Я сделал эти инструменты для поиска узких мест в вашем бизнесе прямо сейчас.',
  'hero.cta.primary': 'Аудит моего бизнеса',
  'hero.cta.secondary': 'Смотреть мастер-класс',
  'hero.cta.tertiary': 'Посмотреть, как я думаю',
  'hero.new.title': 'Мы создаем системы, с которыми вашим бизнесом проще управлять.',
  'hero.new.desc': 'Я создаю быстрые сайты, автоматизирую процессы и внедряю ИИ-системы, чтобы сэкономить ваше время. Я сделал эти инструменты для поиска узких мест в вашем бизнесе прямо сейчас.',
  'hero.new.cta.console': 'Запустить диагностику',
  'hero.new.cta.start': 'Давайте сделаем первый шаг вместе',
